...
const ListAssignedPersonsAll = (props) => {
    ...
    axios
      .get(
        process.env.REACT_APP_API_URL +
          "/cultivator/getassignees?cultivator_id=" + a.user.person_id.toString() +"&currentPage=" +
  ...
  const paginationClicked = (currentPageTemp) => {
    if (
      ...
      if (searchResult) {
        ...
        HttpService.get(
          process.env.REACT_APP_API_URL +
            "/cultivator/searchAll?cultivator_id=" + a.user.person_id.toString()  + "&currentPage=" +
...
//   }
  ...
  function handleSearch() {
    ...
    HttpService.get(
      process.env.REACT_APP_API_URL +
      "/cultivator/searchAll?cultivator_id=" + a.user.person_id.toString()  + "&currentPage=1&pageSize=" +
        pageSize.toString() +
        "&search_input=" +
        searchInput.toString()
    ).then((response) => {
  ...
  useEffect(() => {
    ...
    if (searchResult) 
      ...
      {
        HttpService.get(
          process.env.REACT_APP_API_URL +  "/cultivator/getassignees?cultivator_id=" + a.user.person_id.toString() +"&currentPage=" +
          currentPage.toString() +
          "&pageSize=" +
          pageSize.toString()
        ).then(
...
export default ListAssignedPersonsAll;
